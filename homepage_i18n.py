...
T: dict[str, dict[str, str]] = {
    ...
    "en": {
        ...
        "nav_how": "The method", "nav_features": "Features", "nav_pricing": "Pricing",
        "nav_try": "Analyse for free", "nav_login": "Log in",
        ...
        "res_hook_h": "The hook, decoded",
        "res_action_h": "Your first move for your next video",
        "unlock_title": "The rest of your breakdown is waiting",
        "unlock_li1": "The full verdict: why this video sells",
        "unlock_li2": "What makes it work, and what makes people drop off",
        "unlock_li3": "3 rewritten hooks, ready to test",
        "unlock_li4": "Scripts ready to film for your product",
        "unlock_btn": "See my full breakdown — free",
        "unlock_note": "Free account · {trial}",
        "btn_mission": "Continue my mission →",
        "demo_next_k": "What you do next",
        "demo_next": "Say your call to action at 0:08, right after the demo — not at 0:14.",
        "meth_title": "The Qeerah method",
        "meth_sub": "Find, understand, create, improve. Four steps, and you run them again with every video.",
        "meth_1_k": "Find",
        "meth_1_p": "Spot the videos and products that are selling right now in your country.",
        "meth_1_o": "Feed Radar · products and creators that sell",
        "meth_2_k": "Understand",
        "meth_2_p": "See why a video sells: what you didn't notice on first watch.",
        "meth_2_o": "Breakdown by link or file · several videos at once",
        "meth_3_k": "Create",
        "meth_3_p": "Turn what you understood into hooks and scripts for your product.",
        "meth_3_o": "Multi-angle scripts · hook studio · photo carousels",
        "meth_4_k": "Improve",
        "meth_4_p": "Break down your own videos once they're live: keep what works, fix the rest, go again.",
        "meth_4_o": "Breakdowns of your videos · your winning and losing habits",
        "fr_title": "What's selling today",
        "fr_lock_sub": "Unlocks with your free account",
        "fr_decrypter": "🔍 Break down this video",
        "cta_mission": "Continue my mission",
        "cta_pro": "Upgrade to Qeerah Pro",
        "pr_res1": "<strong>{n} videos broken down</strong> a month — by link or by file",
        "pr_res2": "<strong>Hooks and scripts</strong> ready to film for your products",
        "pr_res3": "<strong>What's selling today</strong> in your country: videos, products, creators",
        "pr_res4": "Breakdowns of <strong>your own videos</strong>, one at a time or several at once",
        "pr_essai": "Start without paying: <strong>{trial}</strong>, with {a} videos to break down.",
        ...
        "demo_tab_0": "Hook decoded", "demo_tab_1": "Triggers", "demo_tab_2": "What you do next",
        ...
        "tool_title": "Paste the link of a video that sells",
        ...
        "fr_sub": "TikTok Shop videos that are selling right now. Pick one and find out why it works.",
        ...
        "pr_title": "Keep understanding what sells, every month",
        "pr_sub": "One plan. Everything included, nothing locked.",
        ...
        "pr_compare": "Everything that's included →",
        ...
        "faq_a1": "Qeerah shows you <strong>why a TikTok Shop video sells</strong> — the hook, the structure, the selling points, the call to action — and what to reuse in your own videos. You find what sells, understand why, adapt it to your product, then check how your video does once it's live.",
        ...
        "faq_a4": "From Feed Radar: the videos and products that sell, tracked over the <strong>last 30 days</strong>, country by country. When TikTok ties a sale directly to a video, you see the real figure (“real GMV”). Otherwise, a video's revenue is <strong>estimated</strong> from its views, an average TikTok Shop conversion rate and the product price — and it's labelled “estimated GMV”.",
        ...
        "ft_product": "Product", "ft_how": "The method", "ft_features": "Features",
        "ft_faq": "FAQ", "ft_pricing": "Pricing", "ft_compare": "Everything that's included",
        "ft_credits": "Credits",
    ...
    "pt-br": {
        ...
        "nav_how": "O método", "nav_features": "Recursos", "nav_pricing": "Preços",
        "nav_try": "Analisar grátis", "nav_login": "Entrar",
        ...
        "res_hook_h": "O gancho, destrinchado",
        "res_action_h": "Sua primeira ação pro próximo vídeo",
        "unlock_title": "O resto do seu diagnóstico tá te esperando",
        "unlock_li1": "O veredito completo: por que esse vídeo vende",
        "unlock_li2": "O que faz ele funcionar, e o que faz a galera sair",
        "unlock_li3": "3 ganchos reescritos, prontos pra testar",
        "unlock_li4": "Roteiros prontos pra gravar com o seu produto",
        "unlock_btn": "Ver meu diagnóstico completo — grátis",
        "unlock_note": "Conta grátis · {trial}",
        "btn_mission": "Continuar minha missão →",
        "demo_next_k": "O que fazer em seguida",
        "demo_next": "Fale sua chamada pra ação aos 0:08, logo depois da demonstração — não aos 0:14.",
        "meth_title": "O método Qeerah",
        "meth_sub": "Encontrar, entender, criar, melhorar. Quatro etapas, e você repete a cada vídeo.",
        "meth_1_k": "Encontrar",
        "meth_1_p": "Descubra os vídeos e produtos que estão vendendo agora no seu país.",
        "meth_1_o": "Feed Radar · produtos e criadores que vendem",
        "meth_2_k": "Entender",
        "meth_2_p": "Veja por que um vídeo vende: o que tinha passado batido na primeira vez.",
        "meth_2_o": "Diagnóstico por link ou arquivo · vários vídeos de uma vez",
        "meth_3_k": "Criar",
        "meth_3_p": "Transforme o que você entendeu em ganchos e roteiros pro seu produto.",
        "meth_3_o": "Roteiros multiângulo · estúdio de ganchos · carrosséis de fotos",
        "meth_4_k": "Melhorar",
        "meth_4_p": "Destrinche seus próprios vídeos depois de publicar: mantenha o que funciona, corrija o resto, recomece.",
        "meth_4_o": "Diagnóstico dos seus vídeos · seus hábitos que vendem e os que não vendem",
        "fr_title": "O que está vendendo hoje",
        "fr_lock_sub": "Libera com a sua conta grátis",
        "fr_decrypter": "🔍 Destrinchar este vídeo",
        "cta_mission": "Continuar minha missão",
        "cta_pro": "Passar para o Qeerah Pro",
        "pr_res1": "<strong>{n} vídeos destrinchados</strong> por mês — por link ou por arquivo",
        "pr_res2": "<strong>Ganchos e roteiros</strong> prontos pra gravar com os seus produtos",
        "pr_res3": "<strong>O que está vendendo hoje</strong> no seu país: vídeos, produtos, criadores",
        "pr_res4": "O diagnóstico dos <strong>seus próprios vídeos</strong>, um por um ou vários de uma vez",
        "pr_essai": "Comece sem pagar: <strong>{trial}</strong>, com {a} vídeos pra destrinchar.",
        ...
        "demo_tab_2": "O que fazer em seguida",
        ...
        "tool_title": "Cole o link de um vídeo que vende",
        ...
        "fr_sub": "Os vídeos do TikTok Shop que estão vendendo agora. Escolha um e descubra por que ele funciona.",
        ...
        "pr_title": "Continue entendendo o que vende, todo mês",
        "pr_sub": "Um plano só. Tudo incluído, nada bloqueado.",
        ...
        "pr_compare": "Tudo o que está incluído →",
        ...
        "faq_a1": "O Qeerah te mostra <strong>por que um vídeo do TikTok Shop vende</strong> — o gancho, a estrutura, os argumentos, a chamada pra ação — e o que levar pros seus próprios vídeos. Você acha o que vende, entende por quê, adapta pro seu produto e depois confere o resultado do seu vídeo publicado.",
        ...
        "faq_a4": "Do Feed Radar: os vídeos e produtos que vendem, levantados nos <strong>últimos 30 dias</strong>, país por país. Quando o TikTok liga uma venda diretamente a um vídeo, você vê o número real (“GMV real”). Senão, o faturamento de um vídeo é <strong>estimado</strong> a partir das visualizações, de uma taxa de conversão média observada no TikTok Shop e do preço do produto — e aparece como “GMV estimado”.",
        ...
        "ft_product": "Produto", "ft_how": "O método", "ft_features": "Recursos",
        "ft_faq": "FAQ", "ft_pricing": "Preços", "ft_compare": "Tudo o que está incluído",
        "ft_credits": "Créditos",
    ...
    "es": {
        ...
        "nav_how": "El método", "nav_features": "Funciones", "nav_pricing": "Precios",
        "nav_try": "Analizar gratis", "nav_login": "Iniciar sesión",
        ...
        "res_hook_h": "El gancho, al descubierto",
        "res_action_h": "Tu primera acción para tu próximo vídeo",
        "unlock_title": "El resto de tu diagnóstico te espera",
        "unlock_li1": "El veredicto completo: por qué vende este vídeo",
        "unlock_li2": "Lo que lo hace funcionar, y lo que hace que la gente se vaya",
        "unlock_li3": "3 ganchos reescritos, listos para probar",
        "unlock_li4": "Guiones listos para grabar con tu producto",
        "unlock_btn": "Ver mi diagnóstico completo — gratis",
        "unlock_note": "Cuenta gratis · {trial}",
        "btn_mission": "Seguir con mi misión →",
        "demo_next_k": "Lo que haces después",
        "demo_next": "Di tu llamada a la acción en el 0:08, justo después de la demostración — no en el 0:14.",
        "meth_title": "El método Qeerah",
        "meth_sub": "Encontrar, entender, crear, mejorar. Cuatro pasos, y vuelves a empezar con cada vídeo.",
        "meth_1_k": "Encontrar",
        "meth_1_p": "Detecta los vídeos y productos que están vendiendo ahora mismo en tu país.",
        "meth_1_o": "Feed Radar · productos y creadores que venden",
        "meth_2_k": "Entender",
        "meth_2_p": "Ve por qué vende un vídeo: lo que no viste la primera vez.",
        "meth_2_o": "Análisis por enlace o por archivo · varios vídeos a la vez",
        "meth_3_k": "Crear",
        "meth_3_p": "Convierte lo que has entendido en ganchos y guiones para tu producto.",
        "meth_3_o": "Guiones multiángulo · estudio de ganchos · carruseles de fotos",
        "meth_4_k": "Mejorar",
        "meth_4_p": "Analiza tus propios vídeos una vez publicados: quédate con lo que funciona, corrige el resto y repite.",
        "meth_4_o": "Análisis de tus vídeos · tus hábitos ganadores y perdedores",
        "fr_title": "Lo que vende hoy",
        "fr_lock_sub": "Se desbloquea con tu cuenta gratis",
        "fr_decrypter": "🔍 Descifrar este vídeo",
        "cta_mission": "Seguir con mi misión",
        "cta_pro": "Pasar a Qeerah Pro",
        "pr_res1": "<strong>{n} vídeos descifrados</strong> al mes — por enlace o por archivo",
        "pr_res2": "<strong>Ganchos y guiones</strong> listos para grabar con tus productos",
        "pr_res3": "<strong>Lo que vende hoy</strong> en tu país: vídeos, productos, creadores",
        "pr_res4": "El análisis de <strong>tus propios vídeos</strong>, uno a uno o varios a la vez",
        "pr_essai": "Empieza sin pagar: <strong>{trial}</strong>, con {a} vídeos para descifrar.",
        ...
        "demo_tab_2": "Lo que haces después",
        ...
        "tool_title": "Pega el enlace de un vídeo que vende",
        ...
        "fr_sub": "Los vídeos de TikTok Shop que están vendiendo ahora mismo. Elige uno y descubre por qué funciona.",
        ...
        "pr_title": "Sigue entendiendo lo que vende, cada mes",
        "pr_sub": "Un solo plan. Todo incluido, nada bloqueado.",
        ...
        "pr_compare": "Todo lo que incluye →",
        ...
        "faq_a1": "Qeerah te enseña <strong>por qué vende un vídeo de TikTok Shop</strong> — el gancho, la estructura, los argumentos, la llamada a la acción — y qué llevarte a tus propios vídeos. Encuentras lo que vende, entiendes por qué, lo adaptas a tu producto y luego compruebas cómo le va a tu vídeo publicado.",
        ...
        "faq_a4": "Del Feed Radar: los vídeos y productos que venden, registrados durante los <strong>últimos 30 días</strong>, país por país. Cuando TikTok vincula una venta directamente a un vídeo, ves la cifra real («GMV real»). Si no, la facturación de un vídeo se <strong>estima</strong> a partir de sus visualizaciones, de una tasa de conversión media observada en TikTok Shop y del precio del producto — y se muestra como «GMV estimado».",
        ...
        "ft_product": "Producto", "ft_how": "El método", "ft_features": "Funciones",
        "ft_faq": "FAQ", "ft_pricing": "Precios", "ft_compare": "Todo lo que incluye",
        "ft_credits": "Créditos",
    ...
    "it": {
        ...
        "nav_how": "Il metodo", "nav_features": "Funzionalità", "nav_pricing": "Prezzi",
        "nav_try": "Analizza gratis", "nav_login": "Accedi",
        ...
        "res_hook_h": "Il gancio, smontato",
        "res_action_h": "La tua prima mossa per il prossimo video",
        "unlock_title": "Il resto della tua analisi ti aspetta",
        "unlock_li1": "Il verdetto completo: perché questo video vende",
        "unlock_li2": "Cosa lo fa funzionare, e cosa fa scappare la gente",
        "unlock_li3": "3 ganci riscritti, pronti da testare",
        "unlock_li4": "Script pronti da girare per il tuo prodotto",
        "unlock_btn": "Vedi tutta la mia analisi — gratis",
        "unlock_note": "Account gratuito · {trial}",
        "btn_mission": "Continua la mia missione →",
        "demo_next_k": "Cosa fai dopo",
        "demo_next": "Dì la tua call to action a 0:08, subito dopo la dimostrazione — non a 0:14.",
        "meth_title": "Il metodo Qeerah",
        "meth_sub": "Trovare, capire, creare, migliorare. Quattro passi, e ricominci a ogni video.",
        "meth_1_k": "Trovare",
        "meth_1_p": "Individua i video e i prodotti che stanno vendendo adesso nel tuo paese.",
        "meth_1_o": "Feed Radar · prodotti e creator che vendono",
        "meth_2_k": "Capire",
        "meth_2_p": "Vedi perché un video vende: quello che ti era sfuggito alla prima visione.",
        "meth_2_o": "Analisi tramite link o file · più video insieme",
        "meth_3_k": "Creare",
        "meth_3_p": "Trasforma quello che hai capito in ganci e script per il tuo prodotto.",
        "meth_3_o": "Script multi-angolo · studio dei ganci · caroselli di foto",
        "meth_4_k": "Migliorare",
        "meth_4_p": "Analizza i tuoi video una volta pubblicati: tieni ciò che funziona, correggi il resto, ricomincia.",
        "meth_4_o": "Analisi dei tuoi video · le tue abitudini vincenti e perdenti",
        "fr_title": "Cosa vende oggi",
        "fr_lock_sub": "Si sblocca con il tuo account gratuito",
        "fr_decrypter": "🔍 Decifra questo video",
        "cta_mission": "Continua la mia missione",
        "cta_pro": "Passa a Qeerah Pro",
        "pr_res1": "<strong>{n} video decifrati</strong> al mese — tramite link o file",
        "pr_res2": "<strong>Ganci e script</strong> pronti da girare per i tuoi prodotti",
        "pr_res3": "<strong>Cosa vende oggi</strong> nel tuo paese: video, prodotti, creator",
        "pr_res4": "L'analisi dei <strong>tuoi video</strong>, uno alla volta o più insieme",
        "pr_essai": "Inizia senza pagare: <strong>{trial}</strong>, con {a} video da decifrare.",
        ...
        "tool_title": "Incolla il link di un video che vende",
        ...
        "fr_sub": "I video di TikTok Shop che stanno vendendo adesso. Scegline uno e scopri perché funziona.",
        ...
        "pr_title": "Continua a capire cosa vende, ogni mese",
        "pr_sub": "Un solo piano. Tutto incluso, niente bloccato.",
        ...
        "pr_compare": "Tutto ciò che è incluso →",
        ...
        "faq_a1": "Qeerah ti mostra <strong>perché un video di TikTok Shop vende</strong> — il gancio, la struttura, gli argomenti, la call to action — e cosa riprendere nei tuoi video. Trovi cosa vende, capisci perché, lo adatti al tuo prodotto e poi verifichi come va il tuo video una volta pubblicato.",
        ...
        "faq_a4": "Dal Feed Radar: i video e i prodotti che vendono, rilevati negli <strong>ultimi 30 giorni</strong>, paese per paese. Quando TikTok collega una vendita direttamente a un video, vedi il dato reale («GMV reale»). Altrimenti il fatturato di un video è <strong>stimato</strong> a partire dalle visualizzazioni, da un tasso di conversione medio osservato su TikTok Shop e dal prezzo del prodotto — ed è indicato come «GMV stimato».",
        ...
        "ft_product": "Prodotto", "ft_how": "Il metodo", "ft_features": "Funzionalità",
        "ft_faq": "FAQ", "ft_pricing": "Prezzi", "ft_compare": "Tutto ciò che è incluso",
        "ft_credits": "Crediti",
    ...
    "de": {
        ...
        "nav_how": "Die Methode", "nav_features": "Funktionen",
        "nav_pricing": "Preise", "nav_try": "Kostenlos analysieren", "nav_login": "Anmelden",
        ...
        "res_hook_h": "Der Hook, entschlüsselt",
        "res_action_h": "Dein erster Schritt fürs nächste Video",
        "unlock_title": "Der Rest deiner Analyse wartet auf dich",
        "unlock_li1": "Das vollständige Fazit: warum dieses Video verkauft",
        "unlock_li2": "Was es funktionieren lässt – und wo die Leute abspringen",
        "unlock_li3": "3 umgeschriebene Hooks, bereit zum Testen",
        "unlock_li4": "Skripte zum Drehen für dein Produkt",
        "unlock_btn": "Meine ganze Analyse ansehen – kostenlos",
        "unlock_note": "Kostenloses Konto · {trial}",
        "btn_mission": "Meine Mission fortsetzen →",
        "demo_next_k": "Was du als Nächstes tust",
        "demo_next": "Sag deinen Call-to-Action bei 0:08, direkt nach der Demo – nicht bei 0:14.",
        "meth_title": "Die Qeerah-Methode",
        "meth_sub": "Finden, verstehen, erstellen, verbessern. Vier Schritte – und bei jedem Video wieder von vorn.",
        "meth_1_k": "Finden",
        "meth_1_p": "Entdecke die Videos und Produkte, die gerade in deinem Land verkaufen.",
        "meth_1_o": "Feed Radar · Produkte und Creator, die verkaufen",
        "meth_2_k": "Verstehen",
        "meth_2_p": "Sieh, warum ein Video verkauft: was dir beim ersten Anschauen entgangen ist.",
        "meth_2_o": "Analyse per Link oder Datei · mehrere Videos auf einmal",
        "meth_3_k": "Erstellen",
        "meth_3_p": "Mach aus dem, was du verstanden hast, Hooks und Skripte für dein Produkt.",
        "meth_3_o": "Multi-Angle-Skripte · Hook-Studio · Fotokarussells",
        "meth_4_k": "Verbessern",
        "meth_4_p": "Analysiere deine eigenen Videos nach der Veröffentlichung: Behalte, was funktioniert, korrigiere den Rest, mach weiter.",
        "meth_4_o": "Analyse deiner Videos · deine erfolgreichen und weniger erfolgreichen Gewohnheiten",
        "fr_title": "Was heute verkauft",
        "fr_lock_sub": "Mit deinem kostenlosen Konto freigeschaltet",
        "fr_decrypter": "🔍 Dieses Video entschlüsseln",
        "cta_mission": "Meine Mission fortsetzen",
        "cta_pro": "Zu Qeerah Pro wechseln",
        "pr_res1": "<strong>{n} entschlüsselte Videos</strong> pro Monat – per Link oder Datei",
        "pr_res2": "<strong>Hooks und Skripte</strong> zum Drehen für deine Produkte",
        "pr_res3": "<strong>Was heute verkauft</strong> in deinem Land: Videos, Produkte, Creator",
        "pr_res4": "Die Analyse <strong>deiner eigenen Videos</strong>, einzeln oder mehrere auf einmal",
        "pr_essai": "Starte ohne zu zahlen: <strong>{trial}</strong>, mit {a} Videos zum Entschlüsseln.",
        ...
        "demo_tab_2": "Was du als Nächstes tust",
        ...
        "tool_title": "Füge den Link eines Videos ein, das verkauft",
        ...
        "fr_sub": "Die TikTok-Shop-Videos, die gerade verkaufen. Such dir eins aus und finde heraus, warum es funktioniert.",
        ...
        "pr_title": "Versteh weiter, was verkauft – jeden Monat",
        "pr_sub": "Ein einziges Angebot. Alles inklusive, nichts gesperrt.",
        ...
        "pr_compare": "Alles, was dabei ist →",
        ...
        "faq_a1": "Qeerah zeigt dir, <strong>warum ein TikTok-Shop-Video verkauft</strong> – den Hook, die Struktur, die Argumente, den Call-to-Action – und was du in deine eigenen Videos übernimmst. Du findest, was verkauft, verstehst warum, passt es an dein Produkt an und prüfst dann, wie dein veröffentlichtes Video läuft.",
        ...
        "faq_a4": "Aus dem Feed Radar: die Videos und Produkte, die verkaufen, erfasst über die <strong>letzten 30 Tage</strong>, Land für Land. Wenn TikTok einen Verkauf direkt einem Video zuordnet, siehst du die echte Zahl („echter GMV“). Sonst wird der Umsatz eines Videos <strong>geschätzt</strong> – aus seinen Aufrufen, einer durchschnittlichen, auf TikTok Shop beobachteten Conversion-Rate und dem Produktpreis – und als „geschätzter GMV“ angezeigt.",
        ...
        "ft_product": "Produkt", "ft_how": "Die Methode", "ft_features": "Funktionen",
        "ft_faq": "FAQ", "ft_pricing": "Preise", "ft_compare": "Alles, was dabei ist",
        "ft_credits": "Guthaben",
